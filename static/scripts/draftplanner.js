...
function appendPokemon(item,gen){
    ...
    usefulmoveslist=["Stealth Rock","Spikes","Toxic Spikes","Sticky Web","Defog","Rapid Spin","Court Change","Mortal Spin","Tidy Up","Healing Wish","Lunar Dance","Heal Bell","Aromatherapy","Wish","Shed Tail","U-turn","Volt Switch","Parting Shot","Flip Turn","Chilly Reception","Knock Off"]
